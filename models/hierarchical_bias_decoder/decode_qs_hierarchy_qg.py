...
def main():
    ...
    parser.add_argument('--output_dir', default=os.path.join(os.getenv('EXPDIR'), 'decode_outputs/qs_hierarchy_qg/hierarchical_bias_decoder'))
    parser.add_argument('--max_length', type=int, default=5120)
    parser.add_argument('--num_shards', type=int, default=1)
    parser.add_argument('--shard_id', type=int, default=0)
    args = parser.parse_args()

    test_dataset = load_dataset('../data_loading_script/summary_generation_data.py', name='qs_hierarchy_qg',
    ...
    def preprocess_function(examples):
        ...
        section_chunk_sizes = []
        section_parent_ids = []
        for tokenized_document_paragraph, document_section_end, document_section_depth, tokenized_section_title, document_section_parent_id, tokenized_first_question, tokenized_first_summary in zip(
