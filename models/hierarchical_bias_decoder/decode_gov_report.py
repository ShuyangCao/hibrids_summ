...
def main():
    ...
    parser.add_argument('--output_dir', default=os.path.join(os.getenv('EXPDIR'), 'decode_outputs/gov_report/hierarchical_bias_decoder'))
    parser.add_argument('--max_length', type=int, default=16384)
    parser.add_argument('--num_shards', type=int, default=1)
    parser.add_argument('--shard_id', type=int, default=0)
    args = parser.parse_args()

    test_dataset = load_dataset('../data_loading_script/summary_generation_data.py', name='gov_report',
