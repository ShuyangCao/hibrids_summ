...
from seq2seq_collator import DataCollatorForLinearTitle, DEPTH_SPECIAL_TOKENS
...
def main():
    ...
    parser.add_argument('--output_dir', default=os.path.join(os.getenv('EXPDIR'), 'decode_outputs/wiki_bio_sum/hierarchical_bias_decoder'))
    parser.add_argument('--max_length', type=int, default=5120)
    parser.add_argument('--num_shards', type=int, default=1)
    parser.add_argument('--shard_id', type=int, default=0)
    args = parser.parse_args()

    test_dataset = load_dataset('../data_loading_script/summary_generation_data.py', name='wiki_bio_sum',
    ...
    def preprocess_function(examples):
        ...
        summary = examples["summary"]  # list of str
        ...
        section_chunk_sizes = []
        section_parent_ids = []
        for tokenized_document_paragraph, document_section_end, document_section_depth, tokenized_section_title, document_section_parent_id in zip(
                tokenized_document_paragraphs, document_section_ends, document_section_depths, tokenized_section_titles,
                document_section_parent_ids):
        ...
        with tokenizer.as_target_tokenizer():
            tokenized_summary = tokenizer(summary, truncation=True, max_length=1024)["input_ids"]
